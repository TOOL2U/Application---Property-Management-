...
// Initialize Firebase
// Note: Firebase config is fetched from your server or injected at build time
// This is a service worker and cannot access process.env directly
// The config should be generated by your build process or fetched from /__/firebase/init.json
firebase.initializeApp({
  apiKey: "REPLACE_AT_BUILD_TIME",  // Injected by build script from EXPO_PUBLIC_FIREBASE_API_KEY
